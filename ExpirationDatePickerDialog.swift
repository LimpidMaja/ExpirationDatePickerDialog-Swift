...
class ExpirationDatePickerDialog: UIView {
    
    typealias DatePickerCallback = (month: Int, year: Int) -> Void
    ...
    func show(title: String, doneButtonTitle: String = "Done", cancelButtonTitle: String = "Cancel", defaultMonth: Int = 0, defaultYear: Int = 0, callback: DatePickerCallback) {
        ...
        self.datePicker.month = self.defaultMonth ?? 0
        self.datePicker.year = self.defaultYear ?? 1
    ...
    private func createContainerView() -> UIView {
        ...
        self.datePicker = MonthYearPickerView(frame: CGRectMake(0, 30, 0, 0))
    ...
    func buttonTapped(sender: UIButton!) {
        if sender.tag == kDatePickerDialogDoneButtonTag {
            self.callback?(month: self.datePicker.month, year: self.datePicker.year)
        }
